...
public class PathConstraints {
    ...
    public static String getImageCachePath(Context context) {
        ...
        String path = directoryPath + File.separator + "DigiFlix_" + System.currentTimeMillis() + ".jpeg";
    ...
    public static String getVideoCachePath(Context context) {
        ...
        String path = directoryPath + File.separator + "DigiFlix_" + System.currentTimeMillis() + ".mp4";
        File file = new File(path);
        if (!file.getParentFile().exists()) {
            file.getParentFile().mkdirs();
        }
