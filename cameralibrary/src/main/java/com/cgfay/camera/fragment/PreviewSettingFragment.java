...
public class PreviewSettingFragment extends Fragment implements View.OnClickListener,
    ...
    CameraPreviewTopbar cameraPreviewTopbar;
    ...
    public Button sec5,sec10,sec15,sec0;
    ...
    private void initView(@NonNull View view) {
        ...
        sec5 = view.findViewById(R.id.sec5);
        sec10 = view.findViewById(R.id.sec10);
        sec15 = view.findViewById(R.id.sec15);
        sec0= view.findViewById(R.id.sec0);

        sec0.setOnClickListener(this);
        sec15.setOnClickListener(this);
        sec5.setOnClickListener(this);
        sec10.setOnClickListener(this);

        int index = cameraPreviewFragment.timer;
        if(index==0){
            sec0.setBackgroundColor(getResources().getColor(R.color.white));
            sec0.setTextColor(getResources().getColor(R.color.black));
        }
        else if(index == 5){
            sec5.setBackgroundColor(getResources().getColor(R.color.white));
            sec5.setTextColor(getResources().getColor(R.color.black));

        }
        else if(index == 10){
            sec10.setBackgroundColor(getResources().getColor(R.color.white));
            sec10.setTextColor(getResources().getColor(R.color.black));
        }
        else if(index==15){
            sec15.setBackgroundColor(getResources().getColor(R.color.white));
            sec15.setTextColor(getResources().getColor(R.color.black));
        }
...
//        updateLuminousCompensationUI();
    ...
    public void onClick(View v) {
        ...
        else if(i==R.id.sec10){
            setTimer(10);
        }
        else if(i==R.id.sec15){
            setTimer(15);
        }
    }

    private void setTimer(int i) {
        cameraPreviewFragment.timer=i;
