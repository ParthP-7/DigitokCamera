...
public class VideoCutViewBar extends View {
    ...
    private final int CROP_TIME_MAX_15 = 60000;

    private final int CROP_TIME_MAX_120 = 120000;

    private final int CROP_TIME_MIN = 10000; // 最小长度为1500毫秒
...
//    // 减速处理，TODO There will be some problems with the audio of the player when sliding, so the deceleration will not be activated for the time being
