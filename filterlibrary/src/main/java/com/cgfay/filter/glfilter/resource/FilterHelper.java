...
public final class FilterHelper extends ResourceBaseHelper {
    ...
    /**
     * Initialize the resources in the Asset directory
     * @param context
     */
    public static void initAssetsFilter(Context context) {
        ...
        mFilterList.clear();
        // 添加滤镜数据
        mFilterList.add(new ResourceData("Beauty", "assets://filter/none.zip", ResourceType.NONE, "none", "assets://thumbs/filter/source.png"));
